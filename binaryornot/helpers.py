...
def _check_is_likely_binary(bytes_to_check):
    """
    :param bytes_to_check: A chunk of bytes to check
    :return: True if is likely binary otherwise False.
    """
...
def _check_is_decodable_as_unicode(bytes_to_check):
    """
    :param bytes_to_check: A chunk of bytes to check
    :return: True if is unicode decodable otherwise False.
    """
...
def _check_has_null_bytes(bytes_to_check):
    """
    :param bytes_to_check: A chunk of bytes to check
    :return: True if it contains null bytes otherwise False.
    """
...
def is_binary_string(bytes_to_check):
    ...
    is_likely_binary = _check_is_likely_binary(bytes_to_check)
    decodable_as_unicode = _check_is_decodable_as_unicode(bytes_to_check)
    ...
    if is_likely_binary:
        ...
        if decodable_as_unicode:
            ...
            return _check_has_null_bytes(bytes_to_check)
